...
```{r, class_proportions, echo=FALSE}
...
```{r, echo = FALSE}
plot(BDmouseBivClass_proportions$biv0CO, ylim=c(-.05, 1.05), col="black")

points(BDmouseBivClass_proportions$biv1CO, col="blue")

points(BDmouseBivClass_proportions$biv2CO, col="red")

points(BDmouseBivClass_proportions$biv3CO, col="orange")
